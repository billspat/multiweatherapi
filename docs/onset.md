...
| sensor_sn      | key & value pairs of sensor serial numbers for measurements that would be included in transformed response (e.g., {'atemp': '123456-7', ... , 'pcpn': '129876-2'}) | dict     |
...
params = {
    ...
    'tz': 'ET'
    'sensor_sn': {'atemp': TEMP_Sensor_SN, 'pcpn': PRECP_Sensor_SN, 'relh': RELHUM_Sensor_SN}
}
...
| :--------------------------------------------: | :-----------------: |
|    [Temperature Sensor SN] --> ['si_value']    |        atemp        |
